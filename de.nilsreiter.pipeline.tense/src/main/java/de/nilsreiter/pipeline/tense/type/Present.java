...
public class Present extends Tense {
  ...
  public final static int typeIndexID = JCasRegistry.register(Present.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Present() {/* intentionally empty block */}
   ...
   */
  public Present(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Present(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
