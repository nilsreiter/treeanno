...
public class Past extends Tense {
  ...
  public final static int typeIndexID = JCasRegistry.register(Past.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Past() {/* intentionally empty block */}
   ...
   */
  public Past(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Past(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
