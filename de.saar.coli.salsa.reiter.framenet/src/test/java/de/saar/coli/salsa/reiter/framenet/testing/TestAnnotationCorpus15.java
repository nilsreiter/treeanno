...
public class TestAnnotationCorpus15 extends TestBase15 {
	...
	export.setLuXSLT(new File("../A10/lexUnit.xsl"));
	export.setLuIndexXSLT(new File("../A10/luIndex.xsl"));
	export.writeToDirectory(ac, new File("/Users/reiter/lu"));
	/*
	...
	try {
	    ...
	    ac2.parse(new File(tmp, "lu"), "lu4224");
	...
	stx.parse(new File("data/SalsaTigerExample-3.xml"));
	...
	export.writeToFile(doc, new File(
		"/Users/reiter/Documents/Eclipse/FrameNet API trunk/lu.xml"));
    }
