...
public abstract class SemanticType implements Serializable, IHasNameAndID,
     ...
     */
    protected void addFrameElement(final FrameElement frameElement) {
     ...
     */
    protected void registerFrameElement(final FrameElement frameElement) {
	init();
	frameElements.add(frameElement);
    }
     ...
     *            The new subtype
     */
    protected void registerSubType(final SemanticType semanticType) {
	init();
