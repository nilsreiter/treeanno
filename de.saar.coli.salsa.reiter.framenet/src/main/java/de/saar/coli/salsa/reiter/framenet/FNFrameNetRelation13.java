 ...
 * 
 */
public class FNFrameNetRelation13 extends FNFrameNetRelation {
    /**
	 * 
	 */
    ...
    protected FNFrameNetRelation13(final FNDatabaseReader reader,
	    final Element node) {
	...
	List<?> list =
		node.element("frame-relations").elements("frame-relation"); // xpath.selectNodes(node);

	for (Object item : list) {
	    try {
		FrameRelation frel =
			new FNFrameRelation13(reader, this, (Element) (item));
