...
public abstract class CorpusReader {
     ...
     *            The Logger object
     */
    public CorpusReader(final FrameNet frameNet, final Logger logger) {
     ...
     */
    public Collection<? extends IRealizedFrame> getRealizedFrames() {
	List<IRealizedFrame> ret = new LinkedList<IRealizedFrame>();
	for (Sentence sentence : sentences) {
	    if (logger != null) {
		logger.fine("Adding realized frames for sentence "
			+ sentence.getIdString());
	    }
