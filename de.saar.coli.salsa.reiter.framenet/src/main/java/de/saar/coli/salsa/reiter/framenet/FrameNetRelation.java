...
public abstract class FrameNetRelation implements Serializable, IHasName,
     ...
     */
    public Collection<Frame> getSuper(final Frame frame) {
     ...
     */
    public Collection<Frame> getSub(final Frame frame) {
	Collection<Frame> ret = new HashSet<Frame>();
	for (FrameRelation frameRelation : frameRelations) {
     ...
     */
    public Collection<Frame> getOther(final Frame frame,
     ...
     */
    public boolean isRelated(final Frame frame) {
     ...
     */
    public boolean isRelated(final FrameElement frameElement) {
