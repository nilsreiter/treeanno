...
public class Polarity_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.ustu.ims.reiter.tense.api.type.Polarity");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("Polarity", "de.ustu.ims.reiter.tense.api.type.Polarity");
