...
public class Aspect_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.ustu.ims.reiter.tense.api.type.Aspect");
  ...
  public String getAspect(int addr) {
      ...
      jcas.throwFeatMissing("Aspect", "de.ustu.ims.reiter.tense.api.type.Aspect");
