 ...
 * @generated */
public class Role_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.nilsreiter.pipeline.uima.event.type.Role");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "de.nilsreiter.pipeline.uima.event.type.Role");
