...
public class TestTokenAlignmentReader {

	TokenAlignmentReader tar;
	...
	public void setUp() {
		...
		tar = new TokenAlignmentReader(dsp);
	}

	@Test
	public void testTokenAlignmentReader() throws IOException {
		Alignment<Token> alignment = tar.read(dsp
				.findStreamFor("alignment1.xml"));
		assertNotNull(alignment);

		assertEquals(4, alignment.getAlignments().size());

		Iterator<? extends Link<Token>> iterator = alignment.getAlignments()
				.iterator();
