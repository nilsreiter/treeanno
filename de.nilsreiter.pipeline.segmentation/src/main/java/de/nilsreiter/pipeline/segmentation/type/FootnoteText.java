 ...
 * @generated */
public class FootnoteText extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(FootnoteText.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected FootnoteText() {/* intentionally empty block */}
   ...
   */
  public FootnoteText(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public FootnoteText(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
