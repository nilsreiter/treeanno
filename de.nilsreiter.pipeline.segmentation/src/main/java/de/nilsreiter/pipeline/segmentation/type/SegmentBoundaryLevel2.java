...
public class SegmentBoundaryLevel2 extends SegmentBoundaryLevel1 {
  ...
  public final static int typeIndexID = JCasRegistry.register(SegmentBoundaryLevel2.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SegmentBoundaryLevel2() {/* intentionally empty block */}
   ...
   */
  public SegmentBoundaryLevel2(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public SegmentBoundaryLevel2(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public SegmentBoundaryLevel2(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
