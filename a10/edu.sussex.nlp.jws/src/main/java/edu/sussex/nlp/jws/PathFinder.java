...
public class PathFinder {
	...
	private void getHypernyms(int pathlength, HashSet<ISynsetID> synsets,
			TreeMap<Integer, HashSet<ISynsetID>> paths) {
		pathlength++;
	...
	public static void main(String[] args) throws IOException {
		...
		String icfile = "C:/Program Files/WordNet/" + 3.0
				+ "/WordNet-InfoContent-" + 3.0 + "/ic-semcor.dat";
		URL url = null;
		try {
		...
		ISynset synset1 = dict.getSynset(new SynsetID(7739125, POS.NOUN)); // apple
																			// s1
		ISynset synset2 = dict.getSynset(new SynsetID(7753592, POS.NOUN)); // banana
																			// s2
		// System.out.println("Get LCS(s)");
		// HashSet<ISynsetID> lcs = pathfinder.getLCSbyPath(synset1, synset2,
		// "n");
