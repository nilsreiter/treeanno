...
public class RootFinder {
	...
	// Infinite loop problem for ( inhibit > <hypernym> < restrain ) ** done **
	// - I have applied the patch that Princeton provide:
	...
	private void write() {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(wnversion
					+ ".roots.out"));
			for (String s : roots) {
				out.write(s + "\n");
			}
