...
public class Resnik {
	...
	// res(1)
	// (text from Perl version) -- Computes the relatedness of two word senses
	// using an information content scheme.
	// The relatedness is equal to the information content of the least common
	// subsumer of the input synsets.
	...
	// The upper bound on the value is generally quite large and varies
	// depending upon the information content file being used.
	// To be precise, the upper bound is ln (N), where N is the sum of the
	// frequencies of all the synsets in the information content files.

	// The Resnick measure is sometimes considered a "coarse" measure.
	// Since the relatedness of two synsets depends only upon the information
	// content of their LCS, all pairs of synsets
	// that have the same LCS will have exactly the same relatedness. For
	// example, the pairs dog#n#1-monkey#n#1 and canine#n#1-primate#n#2.

	// (Perl version) Returns: Unless a problem occurs, the return value is the
	// relatedness score. If no path exists between the two word senses,
	// then **a large negative number** is returned - ??? ugh!!!!

	// (Java version) Returns: Unless a problem occurs, the return value is the
	// relatedness score. If no path exists between the two word senses,
	// then **0** is returned.
	...
	public static void main(String[] args) throws IOException {
		...
		double resscore = res.res("apple", 1, "banana", 2, "n"); // "word1",
																	// sense#,
																	// "word2",
																	// sense#,
																	// "POS"
		System.out.println("specific senses");
		if (resscore != 0) // 0 is an error code i.e it means that something
		...
		TreeMap<String, Double> map = res.res("apple", "banana", "n"); // "word1",
																		// "word2",
																		// "POS"
		...
		double maxvalue = res.max("apple", "banana", "n"); // "word1", "word2",
															// "POS"
		System.out.println("max value");
		System.out.println(formatter.format(maxvalue));
		System.out.println();

		// res(3) all senses of word 1 vs. a specific sense of word 2: a value
		// (score) of 0 is an error code for a pair
		TreeMap<String, Double> map3 = res.res("apple", "banana", 2, "n"); // "word1",
																			// "word2",
																			// sense#,
																			// "POS"
		...
		// res(4) a specific sense of word 1 vs. all senses of word 2: a value
		// (score) of 0 is an error code for a pair
		TreeMap<String, Double> map4 = res.res("apple", 1, "banana", "n"); // "word1",
																			// sense#,
																			// "word2",
																			// "POS"
