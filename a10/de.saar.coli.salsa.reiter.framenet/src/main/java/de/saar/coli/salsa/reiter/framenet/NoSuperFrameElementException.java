...
/**
 * This exception is thrown when a frame element should be generalized in a
 * given frame, but has no inheritance relation with a frame element in that
 * frame.
 * 
 * 
 * @author Nils Reiter
...
public class NoSuperFrameElementException extends FrameNetException {
     ...
     * 
     * @param myFrameElement
     *            The frame element.
     * @param frame
     *            The supposed to be super frame.
     */
    public NoSuperFrameElementException(final FrameElement myFrameElement,
	    final Frame frame) {

	super(myFrameElement.toString() + " has no ancestor in "
		+ frame.getName());
	this.frameElement = myFrameElement;
