...
public class AnnotatedLexicalUnit15 extends AnnotatedLexicalUnit {
	...
	public AnnotatedLexicalUnit15(final AnnotationCorpus annotationCorpus,
		...
		frame = annotationCorpus.getFrameNet().getFrame(
		...
		if (element.element("semType") != null) {
			try {
				semanticType = annotationCorpus.getFrameNet().getSemanticType(
						element.element("semType").attributeValue("name"));
		...
		while (scIter.hasNext()) {
			...
			SubCorpus15 sc15 = new SubCorpus15(this, annotationCorpus, frame,
					subcorpusElement);
		...
		// TODO: Geflickt
		try {
			String lexemeName = element.element("lexeme")
					.attributeValue("name");
			...
			// do nothing if lexemeName can not be found
		}
	}
	...
	public List<de.saar.coli.salsa.reiter.framenet.Sentence> getSentences() {
		List<de.saar.coli.salsa.reiter.framenet.Sentence> ret = new LinkedList<de.saar.coli.salsa.reiter.framenet.Sentence>();
		for (SubCorpus15 sc : subCorpora) {
