 ...
 * @generated */
public class QSAPerson extends QSAType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(QSAPerson.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected QSAPerson() {/* intentionally empty block */}
   ...
   */
  public QSAPerson(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public QSAPerson(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
