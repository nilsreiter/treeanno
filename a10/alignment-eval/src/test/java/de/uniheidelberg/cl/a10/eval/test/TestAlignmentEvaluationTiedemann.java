...
public class TestAlignmentEvaluationTiedemann {
	Token[] t;
	...
	public void testNothingAligned() {
		...
		assertEquals(Double.NaN, res.p(), 0.0);
		assertEquals(Double.NaN, res.getScore(Evaluation.FSCORE), 0.0);
